...
Portage is the off-grid mapping and community-assets capability of the [Hazardscape emergency management platform](https://hazardscape.com). Once a node is connected, it appears as a live marker on your community's map with its name, last-seen time, battery, position, and any sensor readings (temperature, air quality, and more).
